...
class BlogController extends Controller
{
    ...
    */
    public function show()
    {
        ...
        $nbBillets = $this->getDatabase()->getManager('\Project\Model\BilletModel')->countParam(["draft" => 0]);

        $paginator = new Paginator($this->request, (int) $nbBillets['count'], $this->getDatabase()->getManager('\Project\Model\BilletModel'), "PAGE_ARTICLES", "page", ["draft" => 0], "posted_at", true);
